...
Route::middleware(['auth:sanctum'])->prefix('customers')->group(function () {
    ...
    Route::post('/', [CustomerController::class, 'store'])->middleware('role:admin,manager,waiter,cashier');
    Route::get('/{id}', [CustomerController::class, 'show']);
    Route::put('/{id}', [CustomerController::class, 'update'])->middleware('role:admin,manager,waiter,cashier');
